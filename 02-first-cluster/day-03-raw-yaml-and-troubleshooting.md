...
Day 3 Phase 3 — Pod internals: `oc rsh`, `oc exec`, `oc logs`, `oc port-forward`, `oc cp`. Followed by deliberate failure injection in the working cluster to practice recovery.
